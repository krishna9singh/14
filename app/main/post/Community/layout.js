...
export default function CommunityLayout({ children }) {
  ...
  const fetchCom = useCallback(async () => {
    ...
    try {
      ...
      if (res?.data?.success) {
        ...
        setData(merged);
        setLoad(true);
        setCurrentcomId(merged[0]?.posts[0]?._id);
      } else {
        setLoad(false);
      }
    } catch (error) {
  ...
  if (load) {
    return (
      <div className=" w-[100%] h-screen dark:bg-[#171717] flex pn:max-md:justify-center">
        <div className=" pn:max-md:h-[96vh] h-screen overflow-auto scrollbar-hide  bg-white py-12 select-none md:min-w-[390px] md:w-[360px] flex flex-col items-center pb-20 md:pt-20 md:border-r-2 border-[#f7f7f7] dark:border-[#171717]   self-end ">
          {data?.map((d, t) => (
            <React.Fragment key={t}>
              ...
              <Link
                ...
                className="w-[100%] hover:bg-[#f9f9f9] dark:hover:bg-[#171717] rounded-2xl flex flex-col items-center pn:max-md:hidden"
                onClick={() => {
                  setSwitchpost(true);
                }}
              >
                ...
                <div className="h-[55px] px-2 w-[100%] flex flex-row items-center ">
                  <div className="flex flex-row w-[100%] h-[100%] items-center justify-between">
                    ...
                    {sub ? (
                      <div
                        onClick={(e) => {
                          const callme = async () => {
                            ...
                            try {
                              await axios.post(
                                `${API}/joincom/${id}/${d?.community?.creator?._id}`
                              );
                            } catch (e) {
                              console.log(e.message);
                            }
                      ...
                      >
                        <div className="bg-[#fafafa] flex w-[100%] text-[#000] text-[12px] justify-center items-center  font-medium rounded-2xl h-[100%]">
                          Join
                        </div>
                      </div>
                    ) : (
                      <div
                        ...
                        className="cursor-pointer flex h-[35px] w-[25%]  justify-center items-center "
                      >
                        <div className="bg-black flex w-[100%] text-white text-[12px] justify-center items-center  font-medium rounded-xl h-[100%]">
                          Unjoin
                        </div>
                      </div>
                    )}
                ...
                <div className="h-[25px] font-medium overflow-hidden w-[94%]">
                  {d?.posts[0]?.title}
                </div>
                {/* POst */}
              ...
              <Link
                href={{
                  pathname: "../../../phone/CommunityInner",
                  query: { id: id, comId: currentcomId },
                }}
                className="w-[100%] md:hidden dark:hover:bg-[#171717] rounded-2xl flex flex-col items-center"
                onClick={() => {
                  setCurrentcomId(d?.posts[0]?.community?._id);
              ...
              >
                      ...
                      <div
                        onClick={(e) => {
                          const callme = async () => {
                            ...
                            try {
                              await axios.post(
                                `${API}/joincom/${id}/${d?.posts[0]?.community?._id}`
                              );
                            } catch (e) {
                              console.log(e.message);
                            }
                        ...
                        className="cursor-pointer flex h-[35px] w-[20%]  justify-center items-center "
                      >
                        <div className="bg-[#f7f7f7] flex w-[100%] text-[#000] text-[12px] justify-center items-center  font-medium rounded-2xl h-[100%]">
                          Join
                        </div>
                      </div>
                    ) : (
                ...
                <div className="h-[30px] pt-2 text-[15px] font-medium overflow-auto scrollbar-hide text-ellipsis w-[94%]">
                  {d?.posts[0]?.title}
                </div>
                {/* POst */}
                <div className="bg-[#f9f9f9] p-1 rounded-2xl">

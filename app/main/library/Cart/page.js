...
function page() {
  ...
  return (
    <div className="md:flex bg-[#fafafa] h-[91vh] ">
      {data.length === 0 ? (
        <div className="pn:max-md:w-[100%] md:min-w-[390px] pn:max-md:h-[100%] bg-[#f9f9f9] border-r-2 border-[#f9f9f9] flex items-center flex-col">
        ...
        <div className="sm:h-[100%] py-6 pn:max-md:w-[100%] md:min-w-[390px] pn:max-sm:pt-40 bg-[#fafafa] flex items-center flex-col">
          <div
            onClick={() => {
              setUp(false);
            }}
          ...
          {/* product */}
          <div className="w-[90%] h-[110px] py-1 justify-center bg-white flex flex-col rounded-lg items-center">
            <div className="w-[95%] h-[100%] bg-white mt-2 flex flex-row">
              <img
                alt="image"
                src={data[0]?.image}
              ...
              <div className="flex flex-col text-black bg-white px-2">
                <div className="text-[14px] font-semibold">
                  {data[0]?.c?.product?.brandname}
                </div>
                <div className="text-[10px] font-semibold py-1">
                  sold by {data[0]?.c?.product?.sellername}
                </div>
                <div className="flex flex-row  items-center">
                  <div className="text-[14px]">
                    {data[0]?.c?.product?.discountedprice}
                  </div>
                  <div className="text-[12px] text-[#A1A1A1] px-1">
                    {data[0]?.c?.product?.price}
                  </div>
                  <div className="text-[8px] text-[#A1A1A1] px-1">
                    {data[0]?.c?.product?.percentoff}% Off
                  </div>
                </div>

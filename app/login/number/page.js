      ...
      .then(function (res) {
        if (res.data.success === true) {
          if (res.data.userexists) {
            ...
            router.push(`/login/sign?no=${number}`);
          }
        } else {
    ...
    <div>
      ...
      {showOTP ? (
        ...
        <div className="items-center flex flex-col justify-between">
          ...
          <>
            <div className="mx-auto max-w-md w-auto flex justify-center gap-2 p-10">
              {otp.map((value, index) => (
                <>
                  <input
                    key={`otp-field-${index}`}
                    ...
                    className="otp__digit otp__field  outline-slate-200 bg-slate-100 h-[50px] w-[50px] rounded-2xl flex justify-center items-center text-center text-[#3e3e3e]"
                    value={value}
          ...
          <div className="flex justify-start flex-col  items-start  py-4">
            <div className="bg-slate-100 flex items-center justify-center rounded-2xl">
              ...
              <input
                ...
                className="h-[50px] w-[260px] text-[#171717] outline-none bg-slate-100 rounded-r-2xl px-2 p-2 "
              />
            </div>
          </div>
          <div className="py-5 ">
